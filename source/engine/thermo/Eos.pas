...
begin
  ...
  temp_value := APhase.MoleVolume;
  temp_value.Value := APhase.CompressibilityFactor.Value*RGAS*APhase.Temperature.Value/APhase.Pressure.Value;
  APhase.MoleVolume := temp_value;
