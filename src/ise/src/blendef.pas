...
//{$ifdef __FreeBSD__}
//
//function dlsym(handle: integer; sym: integer): integer; {<= !!!6 unknown macro}
//{$endif}
//{$ifdef __WIN32}
//
//function usleep(x: integer): integer; {<= !!!6 unknown macro}
...
//{$ifdef ZRS_DEFINES}
//
//function freeN(x: integer): integer; {<= !!!6 unknown macro}
//{$endif}
//{$ifndef MAXFLOAT}
//MAXFLOAT = ({!!!a type cast? =>} {float(}3.40282347e+38); 
//{$endif}
...
//(* **************** ALGEMEEN ********************* *)
//
//function COREDUMP(n: integer): integer; {<= !!!6 unknown macro}
//
//function VECCOPY(v1: integer; v2: integer): integer; {<= !!!6 unknown macro}
//
//function QUATCOPY(v1: integer; v2: integer): integer; {<= !!!6 unknown macro}
//
//function INPR(v1: integer; v2: integer): integer; {<= !!!6 unknown macro}
//
//function CLAMP(a: integer; b: integer; c: integer): integer; {<= !!!6 unknown macro}
//
//function CLAMPIS(a: integer; b: integer; c: integer): integer; {<= !!!6 unknown macro}
//
//function CLAMPTEST(a: integer; b: integer; c: integer): integer; {<= !!!6 unknown macro}
//
//function IS_EQ(a: integer; b: integer): integer; {<= !!!6 unknown macro}
//
//function INIT_MINMAX(min: integer; max: integer): integer; {<= !!!6 unknown macro}
//
//function DO_MINMAX(vec: integer; min: integer; max: integer): integer; {<= !!!6 unknown macro}
//
//function MINSIZE(val: integer; size: integer): integer; {<= !!!6 unknown macro}
//
...
//(* bit-row *)
//
//function BROW(min: integer; max: integer): integer; {<= !!!6 unknown macro}
//type
//byte16 = record
//a: integer; 
//b: integer; 
...
//end;
//
//function COPY_4(a: integer; b: integer): integer; {<= !!!6 unknown macro}
//
//function COPY_8(a: integer; b: integer): integer; {<= !!!6 unknown macro}
//
//function COPY_12(a: integer; b: integer): integer; {<= !!!6 unknown macro}
//
//function COPY_16(a: integer; b: integer): integer; {<= !!!6 unknown macro}
//
//function LONGCOPY(a: integer; b: integer; c: integer): integer; {<= !!!6 unknown macro}
//
//function SWITCH_LONGINT(a: integer): integer; {<= !!!6 unknown macro}
//
//function SWITCH_INT(a: integer): integer; {<= !!!6 unknown macro}
//
//function SWITCH_SHORT(a: integer): integer; {<= !!!6 unknown macro}
//{$if defined(__sgi) || defined(__SUN) || defined (__PPC__)}
//(* big endian *)
//
//function MAKE_ID2(c: char; d: char): integer; inline;
//const
//MOST_SIG_BYTE = 0; 
//{$define BBIG_ENDIAN}
//{$else}
//(* little endian  *)
//
//function MAKE_ID2(c: integer; d: integer): integer; {<= !!!6 unknown macro}
//MOST_SIG_BYTE = 1; 
...
//NOT_YET = 0; 
//
//function TESTBASE(base: integer): integer; {<= !!!6 unknown macro}
//
//function TESTBASELIB(base: integer): integer; {<= !!!6 unknown macro}
//FIRSTBASE = G.scene.base.first; 
//LASTBASE = G.scene.base.last; 
//BASACT = (G.scene.basact); 
//OBACT = (BASACT {was ?}if  then BASACT.object {was :}else 0); 
//
//function ID_NEW(a: integer): integer; {<= !!!6 unknown macro}
//
//function ID_NEW_US(a: integer): integer; {<= !!!6 unknown macro}
//
//function ID_NEW_US2(a: integer): integer; {<= !!!6 unknown macro}
//CFRA = (G.scene.r.cfra); 
//F_CFRA = ({!!!a type cast? =>} {float(}(G.scene.r.cfra)); 
//SFRA = (G.scene.r.sfra); 
//EFRA = (G.scene.r.efra); 
//
//function ISPOIN(a: integer; b: integer; c: integer): integer; {<= !!!6 unknown macro}
//
//function ISPOIN3(a: integer; b: integer; c: integer; d: integer): integer; {<= !!!6 unknown macro}
//
//function ISPOIN4(a: integer; b: integer; c: integer; d: integer; e: integer): integer; {<= !!!6 unknown macro}
//
//function KNOTSU(nu: integer): integer; {<= !!!6 unknown macro}
//
//function KNOTSV(nu: integer): integer; {<= !!!6 unknown macro}
...
//DL_NORS = 8; 
//
//function DL_SURFINDEX(cyclu: integer; cyclv: integer; sizeu: integer; sizev: integer): integer; {<= !!!6 unknown macro}
//(* **************** SPACE ********************* *)
//(* view3d->flag *)
//V3D_DISPIMAGE = 1; 
//V3D_DISPBGPIC = 2; 
...
//IMAGEFILE = 16; 
//MOVIEFILE = 32; 
//SCROLLH = 16; (* hoogte scrollbar *)
//SCROLLB = 16; (* breedte scrollbar *)
//(* SpaceImage->mode *)
//SI_TEXTURE = 0; 
//SI_SHOW = 1; 
//(* SpaceImage->flag *)
...
//(* ***************** SECTOR ********************* *)
//
//function DYNA_REF(ma: integer): integer; {<= !!!6 unknown macro}
//
//function DYNA_FH_DIST(ma: integer): integer; {<= !!!6 unknown macro}
//
//function DYNA_FH_INT(ma: integer): integer; {<= !!!6 unknown macro}
//
//function DYNA_FH_FRICT(ma: integer): integer; {<= !!!6 unknown macro}
//
//function DYNA_FH_XYFRICT(ma: integer): integer; {<= !!!6 unknown macro}
//
//function DYNA_LAY(ma: integer): integer; {<= !!!6 unknown macro}
//(* ma->mode *)
//DYNA_FH_NORMAL = 1; 
//(* type *)
//SE_CUBE = 0; 
...
//{$endif}
//
//function GS(a: integer): integer; {<= !!!6 unknown macro}
//{$endif}
...
//begin
//  result:= ((fabs({!!!a type cast? =>} {double(}(a)-(b))>={!!!a type cast? =>} {double(}FLT_EPSILON) {was ?}if  then 0 {was :}else 1)
//end;
//
...
//begin
//  result:= (intlcpc:=c,*lcpa:={!!!a type cast? =>} {pinteger(}a,*lcpb:={!!!a type cast? =>} {pinteger(}b;while(lcpc{--} dec(lcpc); >0)*(lcpa{++} inc(lcpa); ):=*(lcpb{++} inc(lcpb); );)
//end;
//
...
//
//{MAKE_ID2(c, d)  ( (c)<<8 | (d) )}
//function MAKE_ID2(c: integer; d: integer): integer; 
//begin
//  result:= ((c) shl 8 or (d))
//end;
//
...
//end;
//
//{ID_NEW(a)  if( (a) && (a)->id.new ) (a)= (void * )(a)->id.new}
//function ID_NEW(a: integer): integer; 
//begin
//  result:= if((a))and((a).id.new)(a):={!!!a type cast? =>} {pinteger(}(a).id.new
//end;
//
//{ID_NEW_US(a) if( (a)->id.new) {(a)= (void * )(a)->id.new; (a)->id.us++;}}
//function ID_NEW_US(a: integer): integer; 
//begin
//  result:= if((a).id.new)((a):={!!!a type cast? =>} {pinteger(}(a).id.new;(a).id.us{++} inc(id.us); ;)
//end;
//
//{ID_NEW_US2(a) if( ((ID * )a)->new) {(a)= ((ID * )a)->new; ((ID * )a)->us++;}}
//function ID_NEW_US2(a: integer): integer; 
//begin
//  result:= if(({!!!a type cast? =>} {pID(}a).new)((a):=({!!!a type cast? =>} {pID(}a).new;({!!!a type cast? =>} {pID(}a).us{++} inc(us); ;)
//end;
//
...
//begin
//  result:= (*({!!!a type cast? =>} {psmallint(}(a)))
//end;
//
end.
